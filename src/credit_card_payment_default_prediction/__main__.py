"""Credit Card Payment Default Prediction file for ensuring the package is executable
as `credit-card-payment-default-prediction` and `python -m credit_card_payment_default_prediction`
"""
import importlib
